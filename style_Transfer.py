...
def save_image(image, filename):
    ...
    mixed_file_path="static/Uploads/"

    with open(mixed_file_path+filename, 'wb') as f:
...
def style_transfer(content_image, style_image,
                   ...
                   weight_denoise=0.3,
                   num_iterations=1000, step_size=10.0):
...
def main(content_image_path,style_image_path):
    ...
    # <unique_filename>.png
    mixed_img= style_transfer(content_image, style_image,
                   content_layer_ids, style_layer_ids,
                   weight_content=1.5, weight_style=10.0,
                   weight_denoise=0.3,
                   num_iterations=1000, step_size=10.0)
